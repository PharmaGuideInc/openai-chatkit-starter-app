    ...
    <aside className="flex h-full w-72 shrink-0 flex-col border-r border-slate-200 bg-white/80 backdrop-blur dark:border-slate-800 dark:bg-slate-900/60">
      <div className="p-3 border-b border-slate-200 dark:border-slate-800">
        ...
        <button
          type="button"
          onClick={onNewChat}
          className="mt-3 w-full rounded-md bg-slate-900 px-3 py-2 text-sm font-medium text-white hover:bg-slate-800 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200"
        >
          New chat
        </button>
      </div>
                    ...
                    <div className={
                      ...
                      {menuOpenFor === t.id ? (
                        ...
                        >
                          ...
                          <button
                            type="button"
                            className="mt-1 block w-full rounded px-2 py-1 text-left text-red-600 hover:bg-red-50 dark:hover:bg-red-950"
